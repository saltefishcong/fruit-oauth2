package com.niubi.authority.implicit.service;

import com.niubi.authority.implicit.eity.User;
import com.niubi.authority.implicit.repository.UserRepository;
...
@Service
public class ImplicaitUserDetailsService implements UserDetailsService {
